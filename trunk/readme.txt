...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\tabimswitch on
     Windows, /home/user/dev/tabimswitch on Linux) in a file named
     TabImSwitch@ftofficer and copy that file to
